...
public class AwsMqttManager {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            AwsIotMqttConnectionBuilder builder = AwsIotMqttConnectionBuilder.newMtlsBuilderFromPath(R.raw.cellphone_cert, R.raw.cellphone_priv);
            if (R.raw.aws_root_ca!= "") {
                builder.withCertificateAuthorityFromPath(null, R.raw.aws_root_ca);
            }
